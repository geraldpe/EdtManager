...
class Fenetre:
    ...
    def verifyMousePosition(self, event, edt_file) -> bool:
        ...
        for day in DAYST:
            for event in edt_file[day]:
                if coo.isInRectangle(x, y, edt_file[day][event]):
                    return (day, event)
    ...
    def addEvent(self, event):
        ...
        hoursbegin = Entry(entriesBeginFrame)
        ...
        hoursEnd = Entry(entriesEndFrame)
    ...
    def createEvent(self, name: str, day: str, color: str, begin: str, end: str, location: str, eventAdder):
        ...
        #format begin
        begin_coordinates = format_time(begin)
        #format end
        end_coordinates = format_time(end)
